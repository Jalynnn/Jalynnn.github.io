...
const ProjectCard = ({ title, image, date, description }) => {
...
const Projects = () => {
  const projects = [
    {
      title: "NAVY Cognitive Load within Virtual Reality",
    ...
    {
      title: "Augmented Reality for Healthcare",
    ...
    {
      title: "Math Study With Matthew Rhodes",
