  ...
  return (
    ...
    {/* <section id="publications" className="section-publications" style="background-image: url('images/backgrounds/AdobeStock_132147953.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat;"> */}
        ...
        <ul className="publication-list">
            ...
            <li className="publication-item">Nicoly, J. B., Masters, R., Gaddy, V., Interrante, V., & Ortega, F. (2024). The restorative influence of virtual reality environment design. <em>ACM Symposium on Applied Perception 2024</em>. <a href="https://doi.org/10.1145/3675231.3675244" rel="noopener noreferrer" target="_blank" style={{ color: '#022943' }}>https://doi.org/10.1145/3675231.3675244</a></li>
            <li className="publication-item">Masters, R., Nicoly, J., Gaddy, V., Interrante, V., & Ortega, F. (2024). The impact of nature realism on the restorative quality of virtual reality forest bathing. <em>ACM Transactions on Applied Perception 2024</em>, <em>17</em>(2). <a href="https://doi.org/10.1145/3670406" rel="noopener noreferrer" target="_blank" style={{ color: '#022943' }}>https://doi.org/10.1145/3670406</a></li>
        </ul>
    </section>
  );
}
