    ...
    return (
        <section id="about" className="section-about">
            ...
            <ul className="research-labs">
                <div className = 'lab'>
                    <img src={`${process.env.PUBLIC_URL}/images/Labs/SHINELabModified.png`} alt="SHINELab Logo" className="lab-imgs"/>
                ...
                <div className = 'lab'>
                    ...
                    <div className='lab-info'>
                        <p>
                            <a href="https://liquetaylor.wixstudio.io/airlab/" target="_blank" rel="noopener noreferrer"><strong>AIRLab</strong></a>
                        </p>
                    </div>
                    <li>
                        <strong>Artificial Intelligence and Robotics Lab:</strong> The summer of 2023 brought me to New York City's Cornell Tech with  <a href="https://www.angeliquemtaylor.com/" rel="noopener noreferrer" target="_blank" style={{ color: 'white' }}><u>Angelique Taylor</u></a>, where I developed an augmented reality application for healthcare settings. My participation in Distributed Research Experience for Undergraduates brought us together as we pursued the idea of improving resuscitation cases by starting with team dynamics.
                    </li>
                </div>
                ...
                <div className = 'lab'>
                    ...
                    <li>
                        <strong>Natural User Interaction Lab:</strong> The most influential research experience I have gained is in <a href="https://compsci.colostate.edu/person/?id=22550A7530193FD205613DD09DD2EE6F&sq=t/" rel="noopener noreferrer" target="_blank" style={{ color: 'white' }}><u>Francisco Ortega's</u></a> research lab. I was in this lab until I graduated, and still am at heart. Here, I was placed on over five research projects, graduating with a co-authorship with ACM TAP 2024 and a first-authorship with ACM SAP 2024.
                    </li>
                </div>
            ...
            <div className="button-container">
                ...
                <button onClick={() => openLink('pdfs/Jalynn Nicoly\'s Resume 9.14.2024.pdf')}>Preview Resume</button>
            </div>
